...
export const MOCK_OFFERS = [
  ...
  },
  {
    ...
    description: 'Buy one coffee and get another one free when you pay with Sampath Bank cards.',
    terms: [
    ...
    bankOffers: [
      {
        ...
        startDate: '2026-02-01',
        endDate: '2026-02-20',
        description: 'Buy one coffee and get another one free when you pay with Sampath Bank credit cards.',
        terms: [
          'Valid for Sampath Bank Credit Cards',
          'Valid Monday to Friday',
          'Cannot be used with meal combos',
